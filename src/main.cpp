...
int64 nChainStartTime = 1422380406;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("e0a1002ea942cdd74d4066b15f9cb47439a2e667bbb3f58a4130cd11973f601a"));
